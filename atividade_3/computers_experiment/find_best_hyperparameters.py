...
corpus_path = "atividade_3/text_databases/Dmoz-Computers.csv"
...
for model, parameters in model_parameters.items():    
    ...
    print(result_df)
    result_df.to_csv(f"outputs/{model_name}_computers_grid_results.csv", index=False)